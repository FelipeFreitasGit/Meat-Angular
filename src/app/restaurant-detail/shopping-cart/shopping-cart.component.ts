  ...
  animations: [
    trigger('row', [
      ...
      transition('void => ready', animate('300ms 0s ease-in', keyframes([
        ...
        style({opacity:0.8, transition: 'translateX(10px)', offset:0.8}),
        style({opacity:1, transition: 'translateX(0px)', offset:1})
      ]))),
      transition('ready => void', animate('300ms 0s ease-out', keyframes([
        style({opacity:1, transition: 'translateX(0px)', offset:0}), 
        style({opacity:0.8, transition: 'translateX(-10px)', offset:0.2}),
